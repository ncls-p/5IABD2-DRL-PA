...
def run_ddqn_pri_exp_replay_example(env_class, env_name, num_episodes=100001):
    env = env_class()
...
def main():
    for env_class, env_name in [
        ...
        scores, steps_per_episode, action_times = run_ddqn_pri_exp_replay_example(env_class, env_name)
